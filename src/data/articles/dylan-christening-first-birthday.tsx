...
import ArticleReviewQuote from "@/components/article/ArticleReviewQuote";
import ArticleCta from "@/components/article/ArticleCta";
import ArticleTLDR from "@/components/article/ArticleTLDR";

import imgFeatureWall from "@/assets/journal/dylan-christening-first-birthday/dylan-christening-blue-gold-balloon-feature-wall.webp";
import imgTeddy from "@/assets/journal/dylan-christening-first-birthday/dylan-first-birthday-teddy-cutout-chrome-gold-balloons.webp";

const DylanChristeningFirstBirthdayArticle = () => (
  <>
    <ArticleTLDR>
      <ul className="list-disc pl-5 space-y-1">
        ...
        <li>
          ...
          work, which freed the palette to stay soft and let the balloons
          lead.
        </li>
        <li>
    ...
    <ArticleProse>
      <p>
        Dylan was being christened and turning one on the same day, and his
        family wanted the two milestones to share a single look rather than
        compete for the room. The venue was an event hall close to{" "}
        <a href="/party-styling-walton-on-thames/">Walton-on-Thames</a>, with
        a black starlight wall
        already built into one end - beautiful to work against, and a gift
        for an evening&nbsp;celebration.
      </p>
      <p>
        The brief was soft, calm and a little bit special. Blue, but not a
        nursery baby-blue. Gold, but warm rather&nbsp;than&nbsp;glitzy.
      </p>
    </ArticleProse>
    ...
    <ArticlePullQuote>
      One day, two milestones - the room had to hold both without leaning
      too far into&nbsp;either.
    </ArticlePullQuote>
    ...
    <ArticleProse>
      ...
      <p>
        ...
        inch, a stem pulled forward - the things a plan can't quite predict
        until the room is&nbsp;lit.
      </p>
    </ArticleProse>
    ...
    >
      Laura created a beautiful balloon hoop garland for my son's
      Christening. It was a beautiful piece of decor and we received loads
      of compliments about it. It really transformed the event hall and was
      stunning. Laura was really easy to communicate with and had great
      creative vision for the event. I would highly recommend this company
      for event&nbsp;decor.
    </ArticleReviewQuote>
    ...
    <ArticleProse>
      ...
      <p>
        ...
        right. It would be easy to design two halves that don't speak to
        each other - a solemn corner and a party corner. The work is finding
        the one look that holds both, so a christening and a first birthday
      ...
      <p>
        ...
        birthday, a naming and an anniversary - and you'd love one
        considered look rather than two competing ones,{" "}
        <a href="/#enquire">tell me what you have in mind</a>. I'll design
        the room&nbsp;around&nbsp;it.
      </p>
      <p>
        - <em>Laura</em>
...
export default DylanChristeningFirstBirthdayArticle;
