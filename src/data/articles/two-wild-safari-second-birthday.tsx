...
import imgBackdropConcept from "@/assets/journal/two-wild-safari-second-birthday/two-wild-safari-feature-backdrop-concept-horley-surrey.webp";
import imgTableConcept from "@/assets/journal/two-wild-safari-second-birthday/two-wild-safari-table-styling-concept-horley-surrey.webp";
import imgFinished from "@/assets/journal/two-wild-safari-second-birthday/two-wild-safari-second-birthday-styling-horley-surrey.webp";

const TwoWildSafariSecondBirthdayArticle = () => (
  <>
    <ArticleTLDR>
      <ul className="list-disc pl-5 space-y-1">
        <li>
          A "Two Wild" safari second birthday designed for{" "}
          <strong>Amiya</strong> at Horley Community Centre, with a
        ...
        <li>
          Palette: dusty pink, peach, sage, soft lilac, butter gold and
          cream. Pulled through every detail from the marquee "2" lights
          to the place&nbsp;settings.
        </li>
        <li>
          A community hall is generous on space but neutral on
          atmosphere. The job is to bring a room with you, not lean on
          the&nbsp;walls.
        </li>
      </ul>
    </ArticleTLDR>
    ...
    <ArticleProse>
      ...
      <p>
        ...
        hall. They had to read as the same celebration without the
        table being a smaller copy of the&nbsp;wall.
      </p>
      <p>
        The render is deliberately illustrative rather than photo-real.
        I want the family to be able to read it in seconds: the panel
    ...
    <ArticlePullQuote>
      A community hall is generous on space but neutral on atmosphere.
      The job is to bring a room with you, not lean&nbsp;on&nbsp;the&nbsp;walls.
    </ArticlePullQuote>
    ...
    <ArticleProse>
      ...
      <p>
        Three things did the heavy lifting. A{" "}
        ...
        backdrop as one continuous&nbsp;installation.
      </p>
      <p>
        Place settings stayed quiet on purpose: pink scallop-edge
        plates, a soft zebra-print salad plate on top as the only
        pattern on the table, brushed gold cutlery and a pink tumbler.
        Pattern earns its place when the rest of the surface is calm.
      </p>
    </ArticleProse>
    ...
    <ArticleProse>
      ...
      <p>
        Once both renders were signed off, the next three weeks were
      ...
      <p>
        Balloons are last and built on site. Latex is biodegradable,
        mixed sizes and finishes (matte pastel, soft chrome gold,
        deeper sage) so the garland and the table clusters read as
        organic rather than rhythmic. Every balloon goes up by hand on
        install&nbsp;morning.
      </p>
    </ArticleProse>
    ...
    <ArticleProse>
      <h2>Delivery day at Horley Community Centre</h2>
      <p>
        Install on a setup of this scale runs about six hours with two
        of us on site. The greenery wall and the personalised panel go
        up first because everything else is composed around them. Then
        the marquee "2" is wheeled into position and the topiary "Two
      ...
      <p>
        ...
        the plates and cutlery, then the integrated balloon clusters
        wired into the runner so they don't drift over the&nbsp;course&nbsp;of&nbsp;the&nbsp;day.
      </p>
      <p>
        ...
        edge. By the time the door opens, the room is doing what both
        sketches&nbsp;promised&nbsp;it&nbsp;would.
      </p>
      ...
      <p>
        Amiya's "Two Wild" is a good one to talk through because the
        two renders and the finished room read as the same image. That
        only happens when the design work has been honest about scale,
...
export default TwoWildSafariSecondBirthdayArticle;
